...
class ServeClientTranslation(ServeClientBase):
    ...
    def __init__(
        ...
        self.model_name = "alirezamsh/small100" if not model_name else model_name
    ...
    def load_translation_model(self):
        ...
        try:
            ...
            logging.info(
                f"Translation model loaded successfully. Target language: {self.target_language}"
            )
    ...
    def process_translation_queue(self):
        ...
        while not self.exit:
            try:
                ...
                if segment is None:
                    logging.info(
                        f"Received exit signal for translation client {self.client_uid}"
                    )
                    break
