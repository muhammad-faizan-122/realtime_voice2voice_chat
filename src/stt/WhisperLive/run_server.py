...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-fw",
        type=str,
        default="models/faster_whisper_tiny",
        help="Custom Faster Whisper Model",
    )
    parser.add_argument(
        "--translation_custom_model_path",
        "-trns",
        type=str,
        default="models/translation",
        help="Custom Translation Model Path",
    )
    ...
    server.run(
        ...
        translation_model_path=args.translation_custom_model_path,
